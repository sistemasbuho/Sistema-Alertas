...
class RedesFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Redes
        fields = ["autor", "url", "proyecto", "fecha_inicio", "fecha_fin", "created_by", "created_by_username", "estado_enviado", "estado_revisado"]
...
class MediosFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Articulo
        fields = ["medio", "url","ciudad", "proyecto", "fecha_inicio", "fecha_fin", "created_by", "created_by_username", "estado_enviado","estado_revisado","autor"]
